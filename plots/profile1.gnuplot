...
set output ARG1
#
set multiplot layout 5,2 title "PKD+AVG Simulation (N=1000), Gain=20mV,$\\sigma_{gain}$=10mV"
...
plot '< ../build/avgsimu --noise=1.2 --nions=1 --pulsewidth=1.0 --gain=20.0 --gain-sigma=10 --width=2.0 --ntrig=1000 --ztrig=0' \
     ...
     , '< ../build/avgsimu --noise=1.2 --nions=1 --pulsewidth=1.0 --gain=20.0 --gain-sigma=10 --width=2.0 --ntrig=1000 --ztrig=0' \
...
plot '< ../build/avgsimu --noise=1.2 --nions=1 --pulsewidth=1.0 --gain=20.0 --gain-sigma=10 --width=2.0 --ntrig=500 --ztrig=500' \
     ...
     , '< ../build/avgsimu --noise=1.2 --nions=1 --pulsewidth=1.0 --gain=20.0 --gain-sigma=10 --width=2.0 --ntrig=500 --ztrig=500' \
     using ($1*1e6):4 with impulses lw 5 lc 3 axes x1y2 notitle
...
plot '< ../build/avgsimu --noise=1.2 --nions=1 --pulsewidth=1.0 --gain=20.0 --gain-sigma=10 --width=2.0 --ntrig=250 --ztrig=750' \
     ...
     , '< ../build/avgsimu --noise=1.2 --nions=1 --pulsewidth=1.0 --gain=20.0 --gain-sigma=10 --width=2.0 --ntrig=250 --ztrig=750' \
     using ($1*1e6):4 with impulses lw 5 lc 3 axes x1y2 notitle
...
plot '< ../build/avgsimu --noise=1.2 --nions=1 --pulsewidth=1.0 --gain=20.0 --gain-sigma=10 --width=2.0 --ntrig=50 --ztrig=950' \
     ...
     , '< ../build/avgsimu --noise=1.2 --nions=1 --pulsewidth=1.0 --gain=20.0 --gain-sigma=10 --width=2.0 --ntrig=50 --ztrig=950' \
     using ($1*1e6):4 with impulses lw 4 lc 3 axes x1y2 notitle
